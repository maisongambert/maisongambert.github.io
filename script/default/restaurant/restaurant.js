...
function restaurant_scroll(){
	...
	if(!isMobile){
		if(pageYOffset>0 && pageYOffset < $smaller2offset - $(window).height()){
	...
	if(!isMobile){
		if(pageYOffset>$smaller2offset - $(window).height() -500){
			...
			//$center_bottom.style[Modernizr.prefixed('transform')] = 'translate3d(0,'+(100-($smaller2offset-window.pageYOffset)/10)+'px, 0)';
			$left_bottom.style[Modernizr.prefixed('transform')] = 'translate3d(0,'+(-30+($smaller2offset-window.pageYOffset)/10)+'px, 0)';
			//$left_bottom_2.style[Modernizr.prefixed('transform')] = 'translate3d(0,'+(($smaller2offset-window.pageYOffset)/10)+'px, 0)';
